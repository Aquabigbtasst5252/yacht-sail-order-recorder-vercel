...
import DailyLostTimePage from './pages/DailyLostTimePage';
        ...
        if (appStatus === 'active') {
             ...
             const renderPage = () => {
                switch(currentPage) {
                    ...
                    case 'daily-lost-time': return (isAdmin || isProduction) ? <DailyLostTimePage user={userData} /> : <Dashboard user={userData} />;
