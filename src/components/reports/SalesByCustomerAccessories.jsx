// src/components/reports/SalesByCustomerAccessories.jsx
import React, { useMemo, forwardRef, useRef, useImperativeHandle } from 'react';
import { Bar } from 'react-chartjs-2';

const SalesByCustomerAccessories = forwardRef(({ orders }, ref) => {
    ...
    const processedData = useMemo(() => {
        ...
        return { labels, data, tableData, title: 'Sales by Customer (Accessories)' };
    }, [orders]);
    ...
    const chartData = {
        ...
        datasets: [ { label: 'Accessories Sold', data: processedData.data, backgroundColor: 'rgba(255, 99, 132, 0.6)' } ],
    };
                        ...
                        <table className="table table-striped table-sm">
                            ...
                            <tbody>
                                {processedData.tableData.length > 0 ? (
                                    ...
                                    <tr>
                                        <td colSpan="2" className="text-center">No accessory sales in this period.</td>
                                    </tr>
                                )}
                            </tbody>
                        </table>
...
export default SalesByCustomerAccessories;