// src/components/reports/ProductTypeAnalysisAccessories.jsx
import React, { useMemo, forwardRef, useRef, useImperativeHandle } from 'react';
import { Pie } from 'react-chartjs-2';

const ProductTypeAnalysisAccessories = forwardRef(({ orders }, ref) => {
    ...
    const processedData = useMemo(() => {
        ...
        return { labels, data, tableData, backgroundColors, title: 'Product Type Analysis (Accessories)' };
    }, [orders]);
                        ...
                        <table className="table table-striped table-sm">
                            ...
                            <tbody>
                                {processedData.tableData.length > 0 ? (
                                    ...
                                    <tr>
                                        <td colSpan="2" className="text-center">No accessory products in this period.</td>
                                    </tr>
                                )}
                            </tbody>
                        </table>
...
export default ProductTypeAnalysisAccessories;